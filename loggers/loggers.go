...
func init(){
	warningFile, err := os.OpenFile("assets/logs/warning.txt", os.O_CREATE|os.O_RDWR|os.O_APPEND, 0666)
	if err != nil{
		log.Fatalln("Couldn't open warning file")
	}

	errorFile, err := os.OpenFile("assets/logs/error.txt", os.O_CREATE|os.O_RDWR|os.O_APPEND, 0666)
	if err != nil{
